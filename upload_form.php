  ...
  <tr> 
    ...
    <td width="78%" valign="top">
      ...
      <div align="center">
        ...
        <table width="79%" border="1" align="center" cellpadding="1" cellspacing="0" bordercolor="#0099FF">
          <tr>
            <td width="27%"><div align="right"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Evento:</font></strong></div></td>
            <td width="73%" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif">
              <input name="evento" type="text" id="fone" size="60" maxlength="100">
            </font></td>
          </tr>
          <tr>
            <td><div align="right">
